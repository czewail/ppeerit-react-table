...
var Body = function (_React$Component) {
    ...
    function Body() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Body.__proto__ || Object.getPrototypeOf(Body)).call.apply(_ref, [this].concat(args))), _this), _this._getCells = function (columns) {
            // 获取组件属性
            var cells = [];
    ...
    _createClass(Body, [{
        ...
        value: function render() {
            ...
            var cells = this._getCells(columns);
...
var Table = function (_React$Component) {
    ...
    function Table() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Table.__proto__ || Object.getPrototypeOf(Table)).call.apply(_ref, [this].concat(args))), _this), _this._getHeader = function (columns) {
            // 定义头部行
            var row = [];
            columns.forEach(function (column) {
                // 定义每个头部格子内容
